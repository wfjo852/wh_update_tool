...
class Ui_wormhole_update_tool(object):
    def setupUi(self, wormhole_update_tool):
        ...
        self.pushb_server_login.setGeometry(QRect(190, 250, 151, 31))
        ...
        self.pushb_wh_update.setGeometry(QRect(550, 380, 151, 31))
        ...
        self.label_wh_update.setGeometry(QRect(60, 310, 151, 16))
        self.layoutWidget1 = QWidget(wormhole_update_tool)
        self.layoutWidget1.setObjectName(u"layoutWidget1")
        self.layoutWidget1.setGeometry(QRect(90, 340, 601, 22))
        ...
        self.pushb_http_login.setGeometry(QRect(540, 250, 151, 31))
