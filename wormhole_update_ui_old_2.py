...
class Ui_wormhole_update_tool(object):
    def setupUi(self, wormhole_update_tool):
        ...
        self.input_host.placeholderText(self.input_host)
    ...
    def retranslateUi(self, wormhole_update_tool):
        wormhole_update_tool.setWindowTitle(QCoreApplication.translate("wormhole_update_tool", u"Wormhole Update Tool", None))
